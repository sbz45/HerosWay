...
public class FightManager : MonoBehaviour
{
    ...
    /// <summary>
    /// if true ,normal attack and skill will NOT work
    /// </summary>
    public bool playerAttackFinish = true;
    ...
    [SerializeField]private FightRoundHandler fightRoundHandler;
    public  void Awake()
    {
        playerAttackFinish = true;
        instance = this;
    ...
    /// <summary>
    /// characters[0]Default to player
    /// </summary>
    /// <param name="characters"></param>
    /// <returns></returns>
    public IEnumerator FightStart(List<Character> characters)
    {
        FightEventListener.FightStart(characters[0],characters[1]);
    ...
    {
        WaitUntil waitUntilPlayerAttacked=new WaitUntil(()=>playerAttackFinish);
        ...
        while (true)
        {
            ...
            fightRoundHandler.GetNextToAction(ref characterInAction);
